...
O3plot7 <- ggplot(EPAair, aes(x = Date, y = Ozone)) +
  ...
  scale_x_date(limits = as.Date(c("2018-01-01", "2019-12-31")), 
    date_breaks = "2 months", date_labels = "%b %y") + # b is 3-letter month
  ylab(expression("O"[3]* " AQI Value")) + # [] specifies subscript
  theme(axis.text.x = element_text(angle = 45,  hjust = 1))
print(O3plot7)  
# hjust = 1 means right justify
```
...
NvsP2 <-
  ...
  labs(y = "N "[mu]"g per liter", x = "P ug per liter", color = "Depth (m)", shape = "Lake Name") + # change your legend labels here
  scale_shape_manual(values = c(15, 17)) +
  #scale_color_distiller(palette = "Blues", direction = 1) + # use scale_color_brewer for discrete variables
  scale_color_viridis(option = "inferno", direction = -1, end = 0.9) +
  theme(legend.position = "right", 
        legend.text = element_text(size = 12), legend.title = element_text(size = 12))
print(NvsP2)

# in scale_color, can add end = to specify what range of palette you want
...
Nutrientplot <-
  ...
  geom_boxplot() + labs(y="N ug/liter") +
# place your additional edits here
  scale_y_continuous(expand = c(0, 0)) +
  #scale_color_brewer(palette = "YlGnBu") +
  #scale_color_manual(values = c("#7fcdbb", "#41b6c4", "#1d91c0", "#225ea8", "#0c2c84")) +
  #scale_color_viridis(discrete = TRUE, end = 0.8) +
  scale_color_discrete(name = "Nutrients", labels = c("ammonia","nitrate","phosphate","nitrogen", "phosphorus")) + theme(legend.position = "bottom")
print(Nutrientplot)
```
