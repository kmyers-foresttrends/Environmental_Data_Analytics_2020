...
```{r}
phos <- ggplot(peterpaul, aes(x=po4, y=tp_ug)) + geom_point(aes(color=lakename)) +  geom_smooth(method = lm, se = FALSE,color="black") + xlim(0,50)

print(phos)

# VALUES NOT APPEARING ON AXES
```
