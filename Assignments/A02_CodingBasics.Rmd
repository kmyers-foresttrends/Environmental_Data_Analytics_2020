...
```{r}
names <- c('Abby', "Bobby", "Connor", "Diana")
scores <- c(92, 88, 49, 95)
...
passgrade(exam_results[1,2])
passgrade(exam_results[2,2])
passgrade(exam_results[3,2])
passgrade(exam_results[4,2])

recipe6 <- function(x){
  ifelse(x<50, return('Fail'), return('Pass'))
  
}

recipe6(exam_results$ExamScores)

```

12. QUESTION: Which option of `if` and `else` vs. `ifelse` worked? Why?

> Answer: Both worked for me?
